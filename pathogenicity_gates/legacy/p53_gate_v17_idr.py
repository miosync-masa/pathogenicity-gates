...
# ══════════════════════════════════════════════════════════════
# SSOC FRAMEWORK IMPORT (relative, within legacy package)
# ══════════════════════════════════════════════════════════════
...
# Phase 4: tetramerization-domain range (p53-specific by default).
# Adapter overrides this per-protein from annotation.domains['tet'].
# None = protein has no oligomer/tet branch.
TET_RANGE = (325, 356)
...
def setup_core_domain(pdb_path='1TSR.pdb', chain='B'):
    ...
    # Phase 4: robust to DNA-free structures (KRAS, BRCA1, etc.)
    # For p53 (1TSR.pdb, DNA present), behaviour is unchanged.
    sc_dna = {}
...
def predict_pathogenicity(pos, wt, mt, ctx, PPI, ppi_nb_count,
    ...
    elif TET_RANGE is not None and TET_RANGE[0] <= pos <= TET_RANGE[1]:  # Tetramerization domain
        channels['Ch1_DNA'] = 'O'
        channels['Ch2_Zn'] = 'O'
        channels['Ch3_Core'] = 'O'
        channels['Ch4_SS'] = 'O'
